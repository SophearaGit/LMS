<footer class="footer_3" style="background: url(/front/images/footer_3_bg.jpg);">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp">
                        <div class="wsus__footer_3_subscribe">
                            ...
                            <ul>
                                <li>
                                    <div class="icon">
                                        <img src="/front/images/call_icon_white.png" alt="Call" class="img-fluid">
                                    </div>
                                    <div class="text">
                                        <h4>Call us:</h4>
                                ...
                                <li>
                                    <div class="icon">
                                        <img src="/front/images/location_icon_white.png" alt="Call"
                                            class="img-fluid">
                                    </div>
                                    <div class="text">
                                        <h4>Office:</h4>
