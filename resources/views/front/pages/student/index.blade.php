            ...
            <div class="row">
                <div class="col-xl-3 col-md-4 wow fadeInLeft">
                    <div class="wsus__dashboard_sidebar">
                        <div class="wsus__dashboard_sidebar_top">
                            ...
                            <div class="img">
                                <img src="/front/images/dashboard_profile_img.png" alt="profile" class="img-fluid w-100">
                            </div>
                            <h4>Norman Gordon</h4>
                            <p>Instructor</p>
                        </div>
                        <ul class="wsus__dashboard_sidebar_menu">
                            ...
                            <li>
                                <a href="dashboard_student.html">
                                    <div class="img">
                                        <img src="/front/images/dash_icon_6.png" alt="icon" class="img-fluid w-100">
                                    </div>
                                    Students
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="dashboard_security.html">
                                    <div class="img">
                                        <img src="/front/images/dash_icon_10.png" alt="icon" class="img-fluid w-100">
                                    </div>
                                    Security
                                </a>
                            </li>
                            <li>
                                <a href="dashboard_social_account.html">
                                    <div class="img">
                                        <img src="/front/images/dash_icon_11.png" alt="icon" class="img-fluid w-100">
                                    </div>
                                    Social Profile
                                </a>
                            </li>
                            <li>
                                <a href="dashboard_notification.html">
                                    <div class="img">
                                        <img src="/front/images/dash_icon_12.png" alt="icon" class="img-fluid w-100">
                                    </div>
                                    Notifications
                                </a>
                            </li>
                            <li>
                                <a href="dashboard_privacy.html">
                                    <div class="img">
                                        <img src="/front/images/dash_icon_13.png" alt="icon" class="img-fluid w-100">
                                    </div>
                                    Profile Privacy
                                </a>
                            </li>
                ...
                <div class="col-xl-9 col-md-8">
                    <div class="alert alert-primary d-flex align-items-center" role="alert">
                        ...
                        <div>
                            Welcome, {{ auth()->user()->name }}. Your instructor request is under review. We'll notify you
                            by email once it's approved.
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="image">
                                                        <div class="image_category">
                                                            <img src="/front/images/courses_3_img_1.jpg" alt="img"
                                                ...
                                                <tr>
                                                    <td class="image">
                                                        <div class="image_category">
                                                            <img src="/front/images/courses_3_img_2.jpg" alt="img"
                                                                class="img-fluid w-100">
                                                        </div>
                                                    </td>
                                                    <td class="details">
                                                ...
                                                <tr>
                                                    <td class="image">
                                                        <div class="image_category">
                                                            <img src="/front/images/courses_3_img_3.jpg" alt="img"
                                                                class="img-fluid w-100">
                                                        </div>
                                                    </td>
                                                    <td class="details">
