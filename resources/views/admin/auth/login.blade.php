...
<head>
    ...
    <link href="/admin/assets/dist/css/tabler-flags.min.css?1692870487" rel="stylesheet" />
    <link href="/admin/assets/dist/css/tabler-payments.min.css?1692870487" rel="stylesheet" />
    <link href="/admin/assets/dist/css/tabler-vendors.min.css?1692870487" rel="stylesheet" />
        ...
        <div class="container container-tight py-4">
            <div class="text-center mb-4">
                <a href="." class="navbar-brand navbar-brand-autodark">
                    <img src="/admin/assets/static/logo.svg" width="110" height="32" alt="Tabler"
            ...
            <div class="card card-md">
                <div class="card-body">
                    ...
                    <form autocomplete="off" novalidate method="POST" action="{{ route('admin.login.store') }}">
                        @csrf
                        <!-- Email Address -->
                        <div class="mb-3">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group input-group-flat">
                                <input type="password" class="form-control" placeholder="Your password"
                                    autocomplete="off" name="password" id="password" required>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col"><a href="javascript:;" class="btn w-100">
