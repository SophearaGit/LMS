...
class CourseContentController extends Controller
{
    ...
    {
        return view('admin.pages.course.course-module.components.partials.course-chapter-modal', compact('course_id'))->render();
    }
    ...
    public function createLessonModal(Request $request)
    {
        ...
        return view('admin.pages.course.course-module.components.partials.chapter-lesson-modal', $data)->render();
    }
    ...
    public function editChapterModal(Request $request)
    {
        ...
        return view('admin.pages.course.course-module.components.partials.course-chapter-modal', $data)->render();
    }
    ...
    public function sortChapter(string $id)
    {
        ...
        return view('admin.pages.course.course-module.components.partials.sorting-chapter-modal', $data)->render();
    }
